"""
Node registry and MNA index allocator.

The :class:`NodeManager` creates nodes, assigns sequential indices,
and — after topology freeze — allocates auxiliary unknowns requested
by components (e.g. branch currents for voltage sources).
"""
