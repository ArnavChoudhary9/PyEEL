"""
Electrical node (net) representation.

A :class:`Node` is the fundamental topological element that components
connect to.  Each non-ground node is assigned a unique integer index
that maps to a row/column in the MNA system.
"""
