...
def AC240V_50Hz(name: str, nodes: tuple[Node, Node], **kw) -> ACVoltageSource:
...
def AC230V_50Hz(name: str, nodes: tuple[Node, Node], **kw) -> ACVoltageSource:
...
def AC120V_60Hz(name: str, nodes: tuple[Node, Node], **kw) -> ACVoltageSource:
...
def AC100V_50Hz(name: str, nodes: tuple[Node, Node], **kw) -> ACVoltageSource:
